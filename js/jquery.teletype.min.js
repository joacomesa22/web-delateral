    ...
    var i = e.extend({}, e.fn.teletype.defaults, t),
      ...
      r = function () {
        i.prefix &&
          ...
          0 === l.loop &&
          0 === l.index &&
          e("<span />").addClass("teletype-prefix").html(i.prefix).prependTo(o);
        ...
        if ("^" == c || "~" == c) {
          ...
          if (e.isNumeric(y)) {
            if (((l.string = l.string.replace(c + y, "")), "^" == c))
              ...
              var h = l.position - y;
              (l.string =
                l.string.substr(0, h - 1) + l.string.substr(l.position - 1)),
                window.setTimeout(function () {
                  p(Math.max(h, 0));
                }, u(i.backDelay));
            }
          ...
          l.position < l.string.length
            ...
            : (s.html(
              ...
              a()
                ...
                : "function" == typeof i.callbackFinished &&
                  i.callbackFinished(n)),
    ...
    return (
      ...
      this.each(function () {
        if (
          ...
          (s = e("<span />").addClass("teletype-text").appendTo(o)),
          i.cursor)
        ) {
